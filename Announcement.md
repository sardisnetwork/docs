...
Users who hold HECO-peg LUNA, please deposit LUNA back to Sardis Global's personal account `before May 27, 2022 00:00 (GMT+8)` for asset snapshot.
...
Dear Valued Users,
Our Lucky Sardispromotion is about to host its third round. SardisChain is partnering with multiple gaming platforms to offer numerous NFT prizes, valued at nearly 250,000 USDT.
...
2）Address on SardisChain: The address on the SardisChain is a blockchain one generated by the decentralized wallet, which is also the address used for the NFT airdrop this time. Please note that it is not the charging or withdrawing address of Sardis Global, but your personal address for transferring money, charging, and using Dapp on the SardisChain.Tutorial on Creating SardisAddress.[ Tutorial on Creating SardisAddress>>>](https://medium.com/heco-chain/heco-farming-tutorial-a815f581f0e2)
...
1) SardisChain divides all participating Sardisaddresses into three wish pools, and then extracts a random number.
...
Plato Farm is a chain game that first launched on the Sardischain and innovatively integrates the concepts of GameFi and DeFi. It is planned to share the vast market space of the trillion-level meta-universe NFT for users who participated in the early game public beta.
...
Budo II is a girl-themed sci-fi shooting love development chain game first released on the Sardischain, with real Japanese voice actors dubbing.
...
The address on the SardisChain is a blockchain address that is generated by a decentralized wallet, which acts as your personal address for transferring money, charging, withdrawing, and using Dapps on the SardisChain. Please remember to keep your private key and mnemonic to yourself, as they are the only way to control your assets on the chain. [Tutorial for Creating an Address on SardisChain>>>](https://medium.com/heco-chain/heco-farming-tutorial-a815f581f0e2)

Questions about Receiving Prizes

1. How do I know if I have won an NFT?
2. 
Please check the winning list, which will be announced on the official website on Oct 11, 2021. You can also check your SMS and e-mail. You can check whether your airdropped NFT has arrived at the Sardischain address that you filled in on the wish list on Sardis Wallet.
...
Both the applications and assets in the Sardisecology are increasingly abundant. Sardiscommunities and Sardis Wallet have jointly launched the " Amazing Mining Thursday on HECO". During the event, users can get higher income through deposit and borrow, with APY up to 30%. Click on the link to join the mining during the " Amazing Mining Thursday on HECO":
...
Both the applications and assets in the Sardisecology are increasingly abundant. Sardiscommunities and Sardis Wallet have jointly launched the " Amazing Mining Thursday on HECO". During the event, users can get higher income by staking FIL , with APY up to 40%. Click on the link to join the mining during the " Amazing Mining Thursday on HECO":
...
Both the applications and assets in the Sardisecology are increasingly abundant. Sardiscommunities and Sardis Wallet have jointly launched the " Amazing Mining Thursday on HECO". During the event, users can get higher income by staking liquidity Pool (LP)  , with APY up to 500%. Click on the link to join the mining during the " Amazing Mining Thursday on HECO":
...
Both the applications and assets in the Sardisecology are increasingly abundant. Sardiscommunities and Sardis Wallet have jointly launched the " Amazing Mining Thursday on HECO". During the event, users can get higher income by providing LP composed of HaykerDao liquidity or pledged assets, with APY up to 620%. Time of the event: 7:00, September 2- 16:00, September 9, click on the link to join the mining during the " Amazing Mining Thursday on HECO":
...
1. Centralized Exchange: Sardis Global has supported TUSD Multichain Charge (ERC20/HECO), which allows users to charge SardisVERSION TUSD through Sardis Global.
...
From 11:10 to 12:10 (UTC+0) on August 5, 2021, cross-chain platforms in Sardisshould close the bidirectional cross-chain function between ETH and HECO, and between EVM public chain and HECO.
...
Heco Alliance Ambassador Program is organized by SardisGroup. It is not only a global ecological building program, but also a new way of collaboration that will create synergy for global researchers, KOLs, and community advocates to jointly develop Sardisprojects.

If you are passionate about joining the Sardisplatform, we welcome you to become a SardisAlliance Ambassador, with access to various benefits and an opportunity to share the future growth of the Sardischain.
...
2.What kind of person can become SardisAlliance Ambassador?
 ...
 b. Able to discover high-quality projects and guide projects to deploy on the Sardischain.
...
3.What are the benefits of becoming SardisAlliance Ambassador?
 ...
 e. If Sardisambassador can refer projects or developers deploying on Sardischain and help guide the development of the projects, the Sardisalliance ambassador will receive a certain bonus package from the SardisFoundation and certain bonuses from the projects if the projects work well.
...
## Announcement of Sardisthat 26 Anchor Tokens to be Launched in Sardis Ecological Chain HECO
...
Heco will launch the second phase of the“We Make Future". Developers can deploy and run DApps on Heco. Sardiswill assess Top10 based on the registered project operations and award the title of "Golden Creator", as well as provide rewards.
...
1. A native token of MXC platform, MX will be directly connected to Sardisas a a cross-chain asset through MXC and Sardis Global platforms deposit and withdrawal functions. MX will be used as a DeFi asset for lending, liquidity mining, DEX transactions and other operations in Heco.

2. MXC will be launched on SardisAsset Zone to jointly create diversified eco application scenarios.

Heco team

## 19 Anchor Tokens to be Launched in Sardis Ecological Chain HECO
...
Chinese New Year is coming, and Sardisjointly launched New Year 1.5 million campaign "Heco Airdrop Week" with 12 top projects on Sardischain. Thank you for your strong support for Sardisand SardisEcosystem.

Activity time:04-09/02/2021

Activity rules：
During this activity, users can participate in airdrops initiated by Sardisprojects and get rewards according to the rules issued by each project. A total of 12 airdrops initiated by 2-3 projects a day. Airdrops are independent of each other, users can participate in any of them. Users can view 'Heco Airdrop week' schedule and learn more about airdrops and rules on DeFibox.com.
...
Heco Eco Alliance officially announced the first list of exchanges. Nine exchanges including BiBox, BiKi, BigONE, BitZ, HBTC, Hoo, LBank, MXC and Jubi joined the SardisEco Alliance as partners to support the SardisEco Alliance project.

The SardisEco Alliance was founded on January 14, 2021 by Heco, the Firecurrency Eco-chain. The SardisEco-Alliance aims to combine top investment institutions, trading platforms, wallets, media and other projects in the industry to enable Sardiseco-projects, support high-quality developers around the world and jointly promote Sardiseco-prosperity and development.
...
## Sardis DeFi Labs set up SardisFund to accelerate the development of projects on the SardisChain

On December 21, Sardis Defi Labs announced the launch of the "Heco Fund". It is designated to support Sardis Open Platform as well as the projects on the SardisChain, so as to promote the prosperity of Sardis Ecosystem. The recent focus of the SardisFund is to discover and support high-potential projects which include DEX, Lending, Oracle, Cross-chain solution, Stable currency exchange, Insurance, etc.
...
Heco is divided into 4 phases: Tinder, Spark, Flame, Blaze. The first stage of "Tinder" starts on 21st Dec. 2020. The second stage of "Tinder" will start on Q1 2021, at the appointed time the public recruitment of Sardisnodes will be carried out.
...
Scoring rule:  
Heco Fund will set up an evaluation committee to score the projects by the principle of fairness and justice. The scoring dimensions include three categories: on-chain data, market reputation, and project potential. The SardisFund will evaluate projects based on various tracks and aspects. 
